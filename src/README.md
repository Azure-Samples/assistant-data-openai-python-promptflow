...
It will show a table of the regions where you have `gpt-35-turbo` available. Note: this script is a tentative to help locating quota, but it might provide numbers that are not accurate. The [Azure OpenAI portal](https://oai.azure.com/) would be the source of truth.
